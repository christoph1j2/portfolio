...
const TechSection = () => {
  ...
  const [sliderRef] = useKeenSlider({
    ...
    updated(s) {
      ...
      s.moveToIdx(
        s.track.details.abs + s.track.details.slides.length,
        true,
        animation,
      );
    },
  ...
  return (
    <>
      <div ref={sliderRef} className="keen-slider tech-section">
        <motion.div
          className="keen-slider__slide slide-html"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          className="keen-slider__slide slide-css"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          className="keen-slider__slide slide-js"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          className="keen-slider__slide slide-react"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          className="keen-slider__slide slide-typescript"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          className="keen-slider__slide slide-csharp"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 1.1 }}
        >
          <TbBrandCSharp className="tech-icon" style={{ color: "#512bd4" }} />
        </motion.div>
        <motion.div
          className="keen-slider__slide slide-blazor"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 1.2 }}
        >
          <SiBlazor className="tech-icon" style={{ color: "#512bd4" }} />
        </motion.div>
        <motion.div
          className="keen-slider__slide slide-mui"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 1.3 }}
        >
          <SiMui className="tech-icon" style={{ color: "#007fff" }} />
        </motion.div>
        <motion.div
          className="keen-slider__slide slide-node"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          className="keen-slider__slide slide-nestjs"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          className="keen-slider__slide slide-visualstudio"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 1.6 }}
        >
          <TbBrandVisualStudio className="tech-icon" style={{ color: "#5c2d91" }} />
        </motion.div>
        <motion.div
          className="keen-slider__slide slide-php"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          className="keen-slider__slide slide-linux"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          className="keen-slider__slide slide-docker"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          className="keen-slider__slide slide-mysql"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          className="keen-slider__slide slide-postgresql"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          className="keen-slider__slide slide-redis"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          className="keen-slider__slide slide-stm"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 2.3 }}
        >
          <SiStmicroelectronics className="tech-icon" style={{ color: "#03234b" }} />
        </motion.div>
        <motion.div
          className="keen-slider__slide slide-c"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 2.4 }}
        >
          <SiC className="tech-icon" style={{ color: "#a8b9cc" }} />
        </motion.div>
        <motion.div
          className="keen-slider__slide slide-arduino"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          className="keen-slider__slide slide-bootstrap"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          className="keen-slider__slide slide-tailwind"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 2.3 }}
        >
