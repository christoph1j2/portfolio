  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="absolute top-10 right-20 w-32 h-32 rounded-full opacity-20 animate-pulse z-[-1]"
          style={{ backgroundColor: "#a5ccff", animationDuration: "3s" }}
        ></div>
        <div
          className="absolute bottom-32 left-16 w-40 h-24 opacity-15 animate-bounce z-[-1]"
          style={{
        ...
        >
          ...
          >
            <span style={{}} className="antonRegular text-cyan-400">
              /
            </span>{" "}
            TVORBA WEBU, CO{" "}
            <ReactTyped
          ...
          >
            Vytváření webovek je moje vášeň. A design je vášeň mé přítelkyně.
            Specializujeme se na moderní, responzivní a funkční weby, které
            nejen vypadají skvěle, ale také plní svůj účel. Ať už potřebujete
            jednoduchou prezentační stránku nebo komplexní webovou aplikaci,
            ...
            {[
              {
                ...
                title: "Rychlý vývoj",
                description:
                  "Díky moderním nástrojům dodáváme kvalitní řešení v krátkém časovém intervalu.",
              },
              {
                icon: <MdDevices className="text-3xl" />,
                title: "Moderní & responzivní design",
                description:
                  "Všechny stránky jsou pečlivě navrženy a jsou optimalizované pro mobily, tablety i počítače.",
              },
              {
                icon: <MdTrendingUp className="text-3xl" />,
                title: "SEO optimalizace",
                description:
                  "Vaše stránky budou nalezitelné ve vyhledávačích a rychle načítatelné.",
              },
              {
                icon: <MdPinDrop className="text-3xl" />,
                title: "Západočeská kvalita",
                description:
                  "Místní podpora a osobní přístup. Všechny projekty jsou konzultovány přímo s klientem.",
              },
              {
                icon: <MdSupportAgent className="text-3xl" />,
                title: "Dlouhodobá podpora",
                description:
                  "Poskytujeme ongoing support, aktualizace a technickou pomoc i po dokončení.",
              },
              {
                icon: <FaRocket className="text-3xl" />,
                title: "Moderní technologie",
                description:
                  "Používáme nejnovější frameworky a nástroje pro maximální výkonnost.",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
      ...
      >
        {/* Decorative elements */}
        <div
          className="absolute top-20 left-10 w-24 h-36 opacity-18 animate-ping"
          style={{
            backgroundColor: "#a5ccff",
        ...
        <div style={{ maxWidth: "80rem", margin: "0 auto" }}>
          ...
          >
            <b>
              Ceny jsou orientační. Vždy záleží na rozsahu, složitosti a
              domluvě.
            </b>{" "}
            <br />
            ...
            {[
              {
                ...
                subtitle:
                  "Ideální pro řemeslníky, živnostníky, malé podniky a firmy",
                price: "od 4 999,- Kč",
              ...
              },
              {
                ...
                bgGradient:
                  "linear-gradient(to bottom right, #dcedf9, #b3d9f2)",
                borderColor: "#81c7e8",
                bulletColor: "#1976d2",
                features: [
          ...
          >
            ...
            >
              Kontaktujte nás pro individuální konzultaci a cenovou nabídku
              šitou na míru vašim potřebám.
            </p>
            <button
